...
from models.backbone import Backbone, BackboneBase, Joiner
...
from discopat.nn_models.detr.util.misc import nested_tensor_from_tensor_list
...
class ONNXExporterTester(unittest.TestCase):
    ...
    def ort_validate(
        self, onnx_io, inputs, outputs, tolerate_small_mismatch=False
    ):
        ...
        ort_inputs = dict(
            (ort_session.get_inputs()[i].name, inpt)
